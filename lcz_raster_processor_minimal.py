"""
LCZ Raster Processor - Minimal version without Shapely
Processes LCZ data from KMZ files containing raster images
"""
import zipfile
import os
...
class LCZRasterProcessor:
    """Process LCZ KMZ files containing raster images - no Shapely required"""
    ...
    def create_box_polygon(self, lon_west, lat_south, lon_east, lat_north):
        """Create a box polygon in GeoJSON format - no Shapely needed"""
        return {
            "type": "Polygon",
            "coordinates": [[
                [lon_west, lat_north],
    ...
    def create_grid_features(self, grid_size=20):
        ...
        for row in range(grid_size):
            for col in range(grid_size):
                ...
                pixels_2d = cell_pixels.reshape(-1, 3)
                ...
                if lcz_class is not None:
                    ...
                    # Create polygon (box) without Shapely
                    polygon = self.create_box_polygon(lon_west, lat_south, lon_east, lat_north)
